...
public interface ActivityBookingsRepository extends JpaRepository<ActivityBookings, Long> {
    ...
    boolean existsByUserIdAndActivityIdAndBookingStatus(Long id, Long id2, String status);

    List<ActivityBookings> findByUserIdAndBookingStatusIn(Long userId, List<String> statuses);

    boolean existsByActivityIdAndUserIdAndBookingStatus(Long activityId, Long userId, String status);
    ...
    @Query("SELECT ab FROM ActivityBookings ab " +
           ...
           "AND ab.activity.business.status.name = 'ACTIVE'")
    ...
    @Query("SELECT ab FROM ActivityBookings ab " +
           ...
           "AND ab.activity.business.status.name = 'ACTIVE'")
    List<ActivityBookings> findByUserIdAndStatusesAndAsctiveBusiness(@Param("userId") Long userId, @Param("statuses") List<String> statuses);
